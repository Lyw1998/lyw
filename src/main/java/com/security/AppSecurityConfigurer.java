...
public class AppSecurityConfigurer extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
    	...
    	.antMatchers("/gt_login","/gt_register","/tt_login","/tt_register","/sp_login","/css/**","/js/**","/img/*","/code/image").permitAll()
		.antMatchers("/gt_user").hasRole("GT")
	  	.antMatchers("/tt_user","/AdoptManager","/RescueManager").hasRole("TT")
	  	.antMatchers("/sp_user","/UserManager","/findAll").hasRole("DBA")
		.and()
		...
		.failureUrl("/gt_login?error=true")
